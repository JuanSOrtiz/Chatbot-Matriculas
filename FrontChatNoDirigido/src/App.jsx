...
function App() {
  ...
  return (
    <div>
      ...
      <button onClick={openModal} style={{backgroundColor:'white', border:'none'}}><img src={BotIASimbol} alt="BotIA" style={{ width: '30%', height: '40%', padding: '10px' }} /></button>
      </div>
        ...
        <MainContainer responsive style={{ height: '600px', display: 'block', borderRadius: '20px' }}>
          <ConversationHeader style={{ backgroundColor: 'ghostwhite', position: 'sticky', top: '0', zIndex: '1' }}>
            <ConversationHeader.Back>
              <FontAwesomeIcon icon={faAngleLeft} onClick={closeModal} />
            </ConversationHeader.Back>
